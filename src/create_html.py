...
def html(movies_summary,movie,image_url,top_review, summary_review, accuracy, name , output_path,start):
    barplot = path.join(output_path, 'barplot.png')
    with open(path.join(output_path, name+".html"), "w",encoding="utf-8") as file:
